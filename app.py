...
st.markdown("You can upload your suspicious .exe file or just drag and drop to find if they are malicious or not! This will give the trained columns with values, the target column value and the result in shorter time!")
...
if uploaded_file is not None:
    ...
    with open(
        r"C:\Users\User\Desktop\pro\inference\{}".format(
            uploaded_file.name
        ),
        "wb",
    ) as f:
        ...
        features = pe_features(
            r"C:\Users\User\Desktop\pro\inference",
            "pred.csv",
        )
        ...
        # delete all the columns except the columns to save
        ...
        xgb_model = joblib.load(
            r"C:\Users\User\Desktop\pro\results\xgb_model.pkl"
        )
